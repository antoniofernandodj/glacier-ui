...
//! (`templates/painel_kdl.kdl`):
//!
//!   - `import "CartaoKdl" from="templates/cartao_kdl.kdl"` — importa outro
...
//!   - `style "styles/painel_kdl.gss"` — carrega uma stylesheet COM ESCOPO:
...
impl Component for Painel {
    ...
    fn template(&self) -> Template {
        Template::File("templates/painel_kdl.kdl".into())
    }
