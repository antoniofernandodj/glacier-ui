...
//! (`examples/estilos_inline_kdl/estilos_inline.kdl`). Como KDL não tem tag de fechamento, o corpo
...
impl Component for Estilos {
    ...
    fn template(&self) -> Template {
        ...
        Template::File("examples/estilos_inline_kdl/estilos_inline.kdl".into())
    }
