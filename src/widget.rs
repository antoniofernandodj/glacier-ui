...
pub(crate) fn parse_length(s: &Option<String>) -> Length {
...
pub fn render_node<'a>(
    ...
    let mut element: Element<'a, EngineMessage> = match &node.kind {
        ...
        NodeType::LcdNumber {
            ...
            pad_zeros,
            ghost,
        } => crate::gauges::render_lcd_number(
            context, value_var, *digits, *size, color, *decimals, *pad_zeros, *ghost,
        ),
        NodeType::LineChart {
            items_var,
            min,
        ...
        NodeType::BarChart {
            ...
            axes,
            grid,
        } => crate::charts::render_bar_chart(
            node, context, items_var, min, max, color, *colorful, *axes, *grid,
        ),
        NodeType::PieChart {
            items_var,
            size,
